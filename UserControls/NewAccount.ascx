...
<div class="textWrap create-account">
	...
	<tr>
	    ...
	    <td><asp:TextBox ID="tbStreetAddress" Runat="server" TabIndex="7" CssClass="formItem" maxlength="100"></asp:TextBox>
            ...
            <td align="right"><asp:Label ID="lblDesiredLoginID" Runat="server" Visible="True"><b>Desired Login ID</b></b></asp:Label></td>
            ...
            <asp:RequiredFieldValidator ID="reqLoginID" Runat="server" ControlToValidate="tbLoginID" CssClass="errorText"
                                Display="Dynamic" ErrorMessage="Desired Login ID is required"> *</asp:RequiredFieldValidator>
        </td>
    </tr>
	<tr>
	    ...
	    <td><asp:TextBox id="tbPassword" Runat="server" TabIndex="16" TextMode="Password" cssclass="formItem" width="100" MaxLength="100" />        
			...
			<asp:RegularExpressionValidator ID="regexPassword" runat="server" ControlToValidate="tbPassword" CssClass="errorText" EnableViewState="true"
			    Display="Dynamic" ValidationExpression=".*" ErrorMessage="Error"> *</asp:RegularExpressionValidator>        </td>
	</tr>
	<tr>
...
<asp:Panel ID="pnlLoginCreated" Runat="server" Visible="False">
	<asp:Label ID="lbLoginCreated" Runat="server" Visible="True"></asp:Label><br />
	<asp:Button ID="btnContinue" Runat="server" CssClass="smallText" Text="Continue"></asp:Button>
</asp:Panel>