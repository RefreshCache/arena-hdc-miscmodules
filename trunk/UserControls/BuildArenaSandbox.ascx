<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BuildArenaSandbox.ascx.cs" CodeBehind="BuildArenaSandbox.ascx.cs" Inherits="ArenaWeb.UserControls.Custom.HDC.MiscModules.BuildArenaSandbox" %>
<%@ Register TagPrefix="Arena" Namespace="Arena.Portal.UI" Assembly="Arena.Portal.UI" %>

<asp:Panel ID="pnlError" runat="server" Visible="false">
  <div style="background-color: #ffbb33; border: solid 2px black; width: 450px; padding: 8px; margin-bottom: 20px;">
...
<asp:Panel ID="pnlReady" runat="server" Visible="false">
  <div style="background-color: #66bb33; border: solid 2px black; width: 450px; padding: 8px; margin-bottom: 20px;">
